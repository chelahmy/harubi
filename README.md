...
Harubi is a **[Model-Action Framework](templates/models)** for rapid implementation of back-end services. It is a MVC-like framework minus the View concerns of front-ends. Nowadays, most front-ends render Views themselves. A front-end may need to access a back-end service only for complex processes and persistance. The absence of the **view** makes harubi much lighter and faster compares to other back-end MVC frameworks. A harubi service can serve all types of front-ends including web, desktop and mobile applications. Harubi is **API-driven**.
